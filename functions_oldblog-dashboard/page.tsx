...
export default function SchedulePage() {
    ...
    try {
      ...
      if (data.success && data.schedule) {
        ...
        setConfig({
          ...
          maxPostsPerDay: data.schedule.maxPostsPerDay || 24,
  ...
  const handleManualTrigger = async () => {
    ...
    try {
      const response = await fetch(`${FIREBASE_URL}/triggerScheduledPost`, {
        method: 'POST'
      });
      const data = await response.json();
      if (data.success) {
        showMessage(`記事を投稿しました: ${data.title}`, 'success');
        await fetchSchedule();
      } else {
          ...
          <div className="space-y-6">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="text-white text-sm">
                      {schedule.todayPostCount || 0} / {schedule.maxPostsPerDay || 24}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={loading || !schedule?.enabled || config.categories.length === 0}
